...
INSERT INTO `opencartcategory` (`category_id`, `image`, `parent_id`, `sort_order`, `date_added`, `date_modified`, `status`) VALUES
...
CREATE TABLE `opencartcategory_description` (
...
INSERT INTO `opencartcategory_description` (`category_id`, `language_id`, `name`, `meta_keywords`, `meta_description`, `description`) VALUES
...
CREATE TABLE `opencartcategory_to_store` (
  `category_id` int(11) NOT NULL,
...
INSERT INTO `opencartcategory_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
INSERT INTO `opencartcountry` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `status`) VALUES
...
INSERT INTO `opencartcoupon` (`coupon_id`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
CREATE TABLE `opencartcoupon_description` (
...
INSERT INTO `opencartcoupon_description` (`coupon_id`, `language_id`, `name`, `description`) VALUES
...
CREATE TABLE `opencartcoupon_product` (
...
INSERT INTO `opencartcoupon_product` (`coupon_product_id`, `coupon_id`, `product_id`) VALUES
(4, 7, 47),
(3, 7, 30),
(8, 6, 48);
...
INSERT INTO `opencartcurrency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
CREATE TABLE `opencartcustomer_group` (
...
INSERT INTO `opencartcustomer_group` (`customer_group_id`, `name`) VALUES
(8, 'Default'),
(6, 'Wholesale');
...
CREATE TABLE `opencartdownload_description` (
...
CREATE TABLE `opencartextension` (
...
INSERT INTO `opencartextension` (`extension_id`, `type`, `key`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
INSERT INTO `opencartgeo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
CREATE TABLE `opencartinformation` (
...
INSERT INTO `opencartinformation` (`information_id`, `sort_order`, `status`) VALUES
(3, 2, 1),
(4, 1, 1),
(5, 3, 1);
...
CREATE TABLE `opencartinformation_description` (
...
INSERT INTO `opencartinformation_description` (`information_id`, `language_id`, `title`, `description`) VALUES
...
CREATE TABLE `opencartinformation_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
INSERT INTO `opencartinformation_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0);
...
INSERT INTO `opencartlanguage` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
...
CREATE TABLE `opencartlength_class` (
...
INSERT INTO `opencartlength_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
CREATE TABLE `opencartlength_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
...
INSERT INTO `opencartlength_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
CREATE TABLE `opencartmanufacturer` (
...
INSERT INTO `opencartmanufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
CREATE TABLE `opencartmanufacturer_to_store` (
...
INSERT INTO `opencartmanufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
CREATE TABLE `opencartorder_download` (
...
CREATE TABLE `opencartorder_history` (
...
CREATE TABLE `opencartorder_option` (
...
CREATE TABLE `opencartorder_product` (
...
CREATE TABLE `opencartorder_status` (
...
INSERT INTO `opencartorder_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
...
CREATE TABLE `opencartorder_total` (
...
INSERT INTO `opencartproduct` (`product_id`, `model`, `sku`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `status`, `date_added`, `date_modified`, `viewed`) VALUES
...
CREATE TABLE `opencartproduct_description` (
  `product_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_bin NOT NULL,
  `meta_keywords` varchar(255) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `opencartproduct_description` (`product_id`, `language_id`, `name`, `meta_keywords`, `meta_description`, `description`) VALUES
(35, 1, 'Product 8', '', '', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n'),
...
CREATE TABLE `opencartproduct_discount` (
...
INSERT INTO `opencartproduct_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
CREATE TABLE `opencartproduct_featured` (
...
INSERT INTO `opencartproduct_featured` (`product_id`) VALUES
(42),
(28),
(43),
(44),
...
CREATE TABLE `opencartproduct_image` (
...
INSERT INTO `opencartproduct_image` (`product_image_id`, `product_id`, `image`) VALUES
...
CREATE TABLE `opencartproduct_option` (
...
INSERT INTO `opencartproduct_option` (`product_option_id`, `product_id`, `sort_order`) VALUES
(283, 40, 1),
(296, 48, 1);
...
CREATE TABLE `opencartproduct_option_description` (
...
INSERT INTO `opencartproduct_option_description` (`product_option_id`, `language_id`, `product_id`, `name`) VALUES
(283, 1, 40, 'Memory'),
(296, 1, 48, 'Memory');
...
CREATE TABLE `opencartproduct_option_value` (
...
INSERT INTO `opencartproduct_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `quantity`, `subtract`, `price`, `prefix`, `sort_order`) VALUES
...
CREATE TABLE `opencartproduct_option_value_description` (
...
INSERT INTO `opencartproduct_option_value_description` (`product_option_value_id`, `language_id`, `product_id`, `name`) VALUES
(563, 1, 40, '16GB'),
(562, 1, 40, '8GB'),
(587, 1, 48, '8GB'),
(586, 1, 48, '1GB');
...
CREATE TABLE `opencartproduct_related` (
  `product_id` int(11) NOT NULL,
...
INSERT INTO `opencartproduct_related` (`product_id`, `related_id`) VALUES
(42, 28),
(42, 41),
(42, 48),
(48, 28),
...
CREATE TABLE `opencartproduct_special` (
...
INSERT INTO `opencartproduct_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
CREATE TABLE `opencartproduct_tags` (
  `product_id` int(11) NOT NULL,
...
CREATE TABLE `opencartproduct_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
INSERT INTO `opencartproduct_to_category` (`product_id`, `category_id`) VALUES
(28, 24),
(29, 24),
(30, 20),
(30, 33),
...
CREATE TABLE `opencartproduct_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
CREATE TABLE `opencartproduct_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `opencartproduct_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
INSERT INTO `opencartreview` (`review_id`, `product_id`, `customer_id`, `author`, `text`, `rating`, `status`, `date_added`, `date_modified`) VALUES
...
INSERT INTO `opencartsetting` (`setting_id`, `group`, `key`, `value`) VALUES
...
(NULL, 'config', 'config_url', 'http://wlt-testbed.elasticbeanstalk.com/store/'),
...
CREATE TABLE `opencartstock_status` (
...
INSERT INTO `opencartstock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(5, 1, 'Out Of Stock'),
(6, 1, '2 - 3 Days'),
(8, 1, 'Pre-Order');
...
CREATE TABLE `opencartstore_description` (
  `store_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `description` text COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `opencarttax_class` (
...
INSERT INTO `opencarttax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
INSERT INTO `opencarttax_rate` (`tax_rate_id`, `geo_zone_id`, `tax_class_id`, `priority`, `rate`, `description`, `date_modified`, `date_added`) VALUES
...
CREATE TABLE `opencarturl_alias` (
...
INSERT INTO `opencarturl_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
CREATE TABLE `opencartuser_group` (
...
INSERT INTO `opencartuser_group` (`user_group_id`, `name`, `permission`) VALUES
...
CREATE TABLE `opencartweight_class` (
...
INSERT INTO `opencartweight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
CREATE TABLE `opencartweight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `opencartweight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
INSERT INTO `opencartzone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
CREATE TABLE `opencartzone_to_geo_zone` (
...
INSERT INTO `opencartzone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
DELETE FROM `opencartuser` WHERE user_id = '1';
INSERT INTO `opencartuser` SET user_id = '1', user_group_id = '1', username = 'admin', password = 'a36d5eb773bcb5f4c72a7b781022a0cd', status = '1', date_added = '2010-02-09 16:27:20';

DELETE FROM `opencartsetting` WHERE `key` = 'config_email';
INSERT INTO `opencartsetting` SET `group` = 'config', `key` = 'config_email', value = 'changfeng.yang@dynatrace.com';	
DELETE FROM `opencartsetting` WHERE `key` = 'config_url';
INSERT INTO `opencartsetting` SET `group` = 'config', `key` = 'config_url', value = 'http://wlt-testbed.elasticbeanstalk.com/store/';
			
UPDATE `opencartproduct` SET `viewed` = '0';
